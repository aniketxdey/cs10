...
public class ImageProcessor {
	...
	/**
	 * Updates the image with the outline of a circle at the location, colored the given color.
	 *
	 * @param x	  center x of circle outline
	 * @param y	  center y of circle outline
	 * @param r   radius of circle outline
	...
	public void drawCircle(int x, int y, int r, Color color) {
		...
		{
			angle = i;
			x1 = r * java.lang.Math.cos(angle * pi / 180);
			y1 = r * java.lang.Math.sin(angle * pi / 180);
			if ((((int)(x + x1)) > 0 ) && ((int)(x + x1) < image.getWidth()) && ((int)(y + y1) > 0) && ((int)(y + y1) < image.getHeight()))
			{
